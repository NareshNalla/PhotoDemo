...
<body>
	...
	<div class="container" id="game_container">game stuff</div>

	<div class="container" id="video_container">video stuff</div>

	<div class="container" id="giveaway_container">giveaway stuff</div>

	<table cellpadding="0" cellspacing="0" border="1"
		class="form_table top-hr" style="width: 790px !important;">
		<tr>
				...
				<table class="regPngImageAreaLeft" cellspacing="10">
					<tr>
						...
						<td style="padding-bottom: 0px;">
							<h1
								style="font-size: 21px !important; margin-top: 0px !important; margin-bottom: 4px !important;">Register
								Account</h1> <span class="smallText">We have made registering
								a new online account fast and easy.</span>
						</td>
					</tr>
					<tr>
						<td style="padding-top: 0px;" class="required"><span
							class="asterik">*</span> Required <a class="clueTip"
							href="${portalHome}/rxsol/chp/html/ps/CH/field.htm"
							rel="${portalHome}/rxsol/chp/html/ps/CH/field.htm"> fields </a></td>
					</tr>
					...
					<c:if test="${rxCtaForm.registrationType=='long'}">
						...
						<tr>
							<td>Please note: These cards are examples only, your
								insurance card may not look like the cards displayed. Please use
								your OptumRx or medical insurance card to locate your member ID.
							</td>
						</tr>
					</c:if>
					...
					<tr>
						<td>
							<div onclick="javascript: webtrends()">
								<div id="clicktocalllink" style="padding-right: 5px !important;">
									<strong>Need Help? Talk to a Representative<span>&nbsp;&#187;</span></strong>
								</div>
							</div>
						</td>
					</tr>
			...
			<td valign="top" style="width: 420px; vertical-align: top;">
				<table cellpadding="0" cellspacing="0" border="0" id="ctaFormTable">
					<tr>
						<td colspan="2" class="header-cell form-hr"><span
							id="personal-info-header">Personal Information</span></td>
						<td colspan="2" class="header-cell form-hr"><img
							id="optumid-logo-sm" alt="OPTUM ID"
							src="${portalHome}/rxsol/chp/html/ps/img/${userClientName}/cta/OptumId_logo_sm.png">
						</td>
					</tr>
					<tr>
						<th></th>
					...
					<tr> 
						<td class="notecontainer" align="center" id="game_container" colspan="4">Note: Your benefits must be active
							with OptumRx in order to complete registration.</td>
					</tr>
					<c:if test="${rxCtaForm.registrationType=='long'}">
						<!-- <tr>   <td colspan="4">Note: Your benefits must be active with OptumRx in order to complete registration.
                                                                                </td>
                                                                                </tr> -->
						<tr>
						...
						<tr>
							<th></th>
							<td  colspan="3"><a id="td-noteid" class="caregiver_a"
								href="#"
								tabindex="2"
								onclick=""
								style="margin-left: 3px;"> Caregiver? Click here &#187;</a></td>
								 <button id="td-noteid" class="btn btn btn-primary active" type="button" >Clear</button>
						</tr>
						<tr class="memberId_warning" style="display: none !important;">
							<th></th>
							<td colspan="3"><span id="memberId_warning"
								style="color: red !important;"></span></td>
						</tr>
						<tr class="memberId_swarning">
							<th></th>
							<td colspan="3"><span id="memberId_swarning"
								style="color: red;"> <spring:hasBindErrors
										name="rxCtaForm">
										<span class="error"> <form:errors path="memberId"
												htmlEscape="false" />
										</span>
					...
					<tr>
						<th scope="row"><span class="asterik">*</span><a
							...
							rel="${portalHome}/rxsol/chp/html/ps/CH/cta_firstname.htm">First
								Name </a></th>
						<td><form:input path="firstName" id="firstName" size="25"
								...
								tabindex="3" /></td>
						<th>Middle</th>
						<td><form:input path="middleInitial" id="middleInitial"
								size="1" maxlength="1" htmlEscape="true"
								cssClass="form-control mi" tabindex="4" /></td>
					</tr>
					...
					<tr class="firstName_warning middleInitial_warning">
						<th></th>
						<td colspan="3"><span id="firstName_warning"
							style="color: red;"></span><span id="middleInitial_warning"
					...
					<tr>
						<th scope="row"><span class="asterik">*</span><a
							...
							rel="${portalHome}/rxsol/chp/html/ps/CH/cta_lastname.htm">Last
								Name </a></th>
					...
					<tr class="lastName_warning" style="display: none !important;">
						<th></th>
						<td colspan="3"><span id="lastName_warning"
							style="color: red;"></span></td>
					</tr>
					<tr class="lastName_swarning">
						<th></th>
						<td colspan="3"><span id="lastName_swarning"
							style="color: red;"> <spring:hasBindErrors
									name="rxCtaForm">
					...
					<tr>
						...
						<td colspan="3"><form:input path="emailAddress"
								id="emailAddress" maxlength="75" htmlEscape="true" tabindex="6"
								cssClass="form-control" /></td>
					</tr>
					<tr class="emailAddress_warning" style="display: none !important;">
						<th></th>
						<td colspan="3"><span id="emailAddress_warning"
							style="display: none;"></span></td>
					</tr>
					<tr>
						<th></th>
						<td colspan="3"><spring:hasBindErrors
								name="rxRegistrationForm">
								<span class="error" id="emailAddress_swarning"
									style="color: #ff0000;"> <form:errors
										path="emailAddress" htmlEscape="false" /></span>
					...
					<tr>
						...
						<td colspan="3"><form:input path="confirmEmailAddress"
								...
								tabindex="7" cssClass="form-control" /></td>
					</tr>
					<tr class="confirmEmailAddress_warning"
						style="display: none !important;">
						<th></th>
						<td colspan="3"><span class=""
							id="confirmEmailAddress_warning" style="display: none;"></span></td>
					</tr>

					<tr class="confirmEmailAddress_swarning">
						<th></th>
						<td colspan="3"><span id="confirmEmailAddress_swarning"
							style="color: red" class="error"> <spring:hasBindErrors
									name="rxRegistrationForm">
					...
					<tr>
						...
						<td colspan="3" style="width: 618px !important;"><span
							class="error dateOfBirth" id="dateOfBirth"
							style="width: 260px !important;"> <form:select
								...
								</form:select> <form:select path="bodYear" tabindex="10"
									cssStyle="width:80px;">
					...
					<tr>
						<th></th>
						<td colspan="3"><spring:hasBindErrors name="rxCtaForm">
								<span class="error" style="color: red;"><form:errors
										path="dateOfBirth" htmlEscape="false" /></span>
							</spring:hasBindErrors></td>
					</tr>
					...
					<tr>
						...
						<td colspan="3"
							...
							<span id="gender"
							style="_width: 180px; *width: 183px; width: 180px;"><form:radiobutton
									path="gender" id="male" value="M" tabindex="11"
									cssClass="radio_selects">
								</form:radiobutton> <label for="male"><strong>&nbsp;Male</strong></label>&nbsp;&nbsp;
								<form:radiobutton path="gender" id="female" value="F"
									tabindex="12" cssClass="radio_selects">
								</form:radiobutton> <label for="female"><strong>&nbsp;Female</strong></label></span>
						</td>
						<td style=""></td>
					</tr>
					...
					<tr>
						...
						<td colspan="3"><form:input path="addressLine1"
								id="addressLine1" size="25" maxlength="32" htmlEscape="true"
								cssClass="form-control" tabindex="13" /></td>
					</tr>
					<tr class="addressLine1_warning"
						style="display: none !important; padding-left: 0px;">
						<th></th>
					...
					<tr>
						...
						<td colspan="3"><form:input path="addressLine2"
								id="addressLine2" size="25" maxlength="32" htmlEscape="true"
								cssClass="form-control" tabindex="14" /></td>
					</tr>
					<tr>
						<th></th>
						<td colspan="3"></td>
					...
					<tr>
						...
						<td colspan="3"><form:input path="city" id="city" size="25"
								maxlength="24" htmlEscape="true" cssClass="form-control"
								tabindex="15" /></td>
					</tr>
					...
					<tr class="city_swarning">
						<th></th>
						<td colspan="3"><span id="city_swarning"
							style="color: red; padding-left: 0px;"> <spring:hasBindErrors
									name="rxCtaForm">
					...
					<tr>
						...
						<td colspan="3"><span class="error state" id="state">
								<form:select path="state" id="state" tabindex="16"
									items="${statesMap}" />
						</span></td>
					</tr>
					<tr>
						...
						<td colspan="3"><span id="state_warning"
							...
							id="state_swarning" style="color: red;"> <spring:hasBindErrors
									name="rxCtaForm">
					...
					<tr>
						<th scope="row"><span class="asterik">*</span>ZIP Code</th>
						<td colspan="3"><form:input path="zip" id="zip" size="25"
								maxlength="10"
					...
					<tr>
						...
						<td colspan="3"><form:input path="phoneNumberSec1"
								...
								path="phoneNumberSec2" id="phoneNumberSec2" size="3"
								maxlength="3" tabindex="19" cssClass="three_space"
								...
								cssStyle="width:40px; border:1px solid #000000;" /> <form:input
								path="phoneNumberSec3" id="phoneNumberSec3" size="4"
								maxlength="4" tabindex="20" cssClass="four_space"
					...
					<tr class="phone_warning">
						<th></th>
						<td colspan="3"><span id="phone_warning"
							style="color: red; display: none; padding-left: 0px;"></span></td>
					</tr>
					<tr>
						<th><div style="position: relative; padding-bottom: 100%;">
								<span class="asterik">*</span>I agree
								<form:checkbox path="certified" id="certified" tabindex="21"
									cssStyle="position: relative; top: 3px;" />
							</div></th>
						<td colspan="3">
							<p>By checking this box, I hereby certify that the above
								information is true and correct and accurately reflects MY
								personal information and not that of some other person. I also
								understand that information about my prescriptions may be sent
								to the email address I provided.</p>
						</td>
					</tr>
					<tr class="certified_warning" style="display: none !important;">
						<th></th>
						<td colspan="3"><span id="certified_warning"
							style="color: red;"></span></td>
					</tr>
					<tr class="certified_swarning">
						<th></th>
						<td colspan="3"><span id="certified_swarning"
							style="color: red; padding-left: 0px;"> <spring:hasBindErrors
									name="rxCtaForm">
					...
					<tr>
						<th scope="row"></th>
						<td colspan="3"><a
							onclick="window.location.href='${mainContentWebappContextUrl}/mvc/j_spring_security_logout'; return false;">
								<input type="image" class="form-control-btn"
								src="${portalHome}/rxsol/chp/html/ps/img/${userClientName}/cta/Cancel_btn_ON.png"
								value="cancel" alt="Cancel" title="Cancel" id="cancel_button" />
						</a> <a class="lock"
							onclick="validateForm(document.getElementById('rxCtaForm'));return false;">
								<input type="image" class="form-control-btn"
								src="${portalHome}/rxsol/chp/html/ps/img/${userClientName}/cta/Submit_btn_ON.png"
								value="submit" alt="Submit" title="Submit" id="submit_button" />
						</a></td>
					</tr>
				</table>
			</td>
